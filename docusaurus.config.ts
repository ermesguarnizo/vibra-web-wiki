...
const config: Config = {
  ...
  url: 'https://proyectohhss2025-unad.github.io',
  ...
  organizationName: 'proyectohhss2025-unad', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Vibra, Inc. Built with Docusaurus.`,
    },
    prism: {
